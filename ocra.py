...
def loss_fn(objcaps_len_step, read_x_step, c_step, readout_logits, x, y_true, yloss_w, args, writer=None, step=None):
    """
...
def evaluate(model, x, y_true, loss_fn, args, epoch=None):
    ...
    # compute loss    
    loss, L_recon, L_margin = loss_fn(objcaps_len_step, read_x_step, c_step, readout_logits, x, y_true, yloss_w, args)        
...
#     time.sleep(0.1)        
        ...
        for i, (x, y, yloss_w) in enumerate(train_dataloader):
            ...
            loss, _ , _ = loss_fn(objcaps_len_step, read_x_step, c_step, readout_logits, x, y, yloss_w, args, writer, global_step)
